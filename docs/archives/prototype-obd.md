# Archive historique : server/server.js

Prototype non opérationnel, conservé pour référence. Ne pas exécuter ni réutiliser
les avis fictifs comme données réelles. Le serveur actif est server-simple.js.

Source exacte : `98f04f9:server/server.js`. Seuls les espaces de fin de ligne
sont nettoyés dans cette copie documentaire.
